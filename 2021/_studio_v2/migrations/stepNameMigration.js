...
// Run this script from within your project folder in your terminal with: 
// `sanity exec --with-user-token migrations/stepNameMigration.js`
//
...
const fetchDocuments = () =>
  client.fetch(`*[_type == 'method' && defined(complexOverviewSources)][0...50] {_id, _rev, complexOverviewSources}`)

const buildPatches = docs =>
  docs.map(doc => ({
    id: doc._id,
    patch: {
      set: {overviewSources: doc.complexOverviewSources},
      unset: ['complexOverviewSources'],
