 ...
 * 4. Run `sanity exec migrations/deleteConcepts.js --with-user-token` to delete the documents
 *
 ...
 * Source: https://www.sanity.io/schemas/delete-documents-by-filter-698e1f26
 */

import client from 'part:@sanity/base/client'

client
  .delete({query: '*[_type == "concept"][0...100]'})
  .then(console.log)
  .catch(console.error)
